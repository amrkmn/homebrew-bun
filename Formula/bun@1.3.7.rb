class BunAT137 < Formula
  ...
  url "https://registry.npmjs.org/bun/-/bun-1.3.7.tgz"
  sha256 "a5b4a081d7cbe00feec3485ae8fe8f6637c2593a31b215227130bfbf4d3ffbae"
  license "MIT"
  revision 2

  bottle do
    root_url "https://ghcr.io/v2/amrkmn/bun"
    sha256 cellar: :any_skip_relocation, arm64_linux:  "bbdb2003b0e3164e8f0f0e7864442aeddca60dcdcc3817ec77fa134baca72fbb"
    sha256 cellar: :any_skip_relocation, x86_64_linux: "0b0ac7f4c22539dcc768b2fb1e549e91c039c16bba60760a7c374b637cf5556c"
  end

...
# create-versioned-formulae.sh - Script to create versioned formulae for bun
...
main() {
  ...
  if [[ -t 0 ]]; then
    ...
    echo "Usage: brew livecheck --tap=\"\$GITHUB_REPOSITORY\" --json | ./create-versioned-formulae.sh" >&2
    exit 1
  fi
